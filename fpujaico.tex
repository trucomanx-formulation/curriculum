...
\cvitem{Currículo Lattes}{\url{https://buscatextual.cnpq.br/buscatextual/visualizacv.do?id=K4323460H7}}
%----------------------------------------------------------------------------------------
%	IDENTIFIADORES
%----------------------------------------------------------------------------------------
...
\cventry{2025}{Doutorado em Engenharia Elétrica (Processamento de Sinais e Imagens)}
	      {Centro Universitário da Fundação Educacional Inaciana Pe. Sabóia de Medeiros}
	      {FEI}{Brasil}
	      {Título: Classificação da linguagem corporal de pacientes no leito utilizando aprendizado profundo. \textbf{Tese defendida: 2025-06-12}}
	      
\cventry{2014}{Doutorado em Engenharia Elétrica (Telecomuncações e Telemática)}
	      {Universidade Estadual de Campinas}
	      {UNICAMP}{Brasil}
	      {Título: Algoritmos Bit-Flipping Para Decodificação Conjunta de Fontes Correlacionadas Em Canais Ruidosos.}
	      
\cventry{2011}{Mestrado em Engenharia Elétrica (Telecomuncações e Telemática)}
	      {Universidade Estadual de Campinas}
	      {UNICAMP}{Brasil}
